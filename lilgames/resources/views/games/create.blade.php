<x-layout>
    ...
    <form id="formRegister" class="row g-3 needs-validation" autocomplete="off" method="post" action="/catalog/create/form">
        ...
        <div class="mb-3 col-12 text-center">
            ...
            <input type="text" class="form-control" name="nombreJuego" id="nombreJuego" placeholder="Nombre Juego" required maxlength="100"/>
        </div>
        <div class="mb-3 col-12 text-center">
            <label for="info" class="form-label text-white fs-5">Informacion del Juego</label>
            <input type="text" class="form-control" name="info" id="info" placeholder="Informacion" maxlength="255"/>
        </div>
        <div class="mb-3 col-12 text-center">
